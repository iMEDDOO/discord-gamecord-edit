...
module.exports = class RPSGame extends approve {
  ...
  async RPSGame(msg) {
    ...
    await msg.edit({ content: `${this.message.author} vs ${this.opponent}`, embeds: [embed], components: [row] });
  ...
  async gameOver(msg, result) {
    ...
    return msg.edit({ content: `${this.message.author} vs ${this.opponent}`, embeds: [embed], components: [] });
  }
}